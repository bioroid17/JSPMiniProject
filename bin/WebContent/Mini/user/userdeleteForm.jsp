				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<section>
									<form method="post" action="userdeletePro.do?userId=${dto.userId}" name="usermodifyForm" onsubmit="return modifycheck()">
										...
										<div class="col-12">
												<ul class="actions">
													<li><input type="submit" value="탈퇴하기" class="primary" /></li>
