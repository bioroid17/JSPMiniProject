				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<section>
									<form method="post" action="signupPro.do" name="signupForm" onsubmit="return signcheck()">
										<input type="hidden" value="0" name="confirmvalue">
										<input type="hidden" value="0" name="confirmtelvalue">
										<div class="row gtr-uniform">
											<div class="col-6 col-12-small">
												<input type="text" name="userId" id="demo-name" placeholder="아이디" onkeyup="useridconfirm()" />
											</div>
											...
											<input type="hidden" name="userInfo" value="일반회원"/>
										...
										{	// json 영역
											...
											success : function(data) {
												...
												if(data.indexOf('사용할 수 있는') != -1){
													signupForm.confirmvalue.value = "1";
												} else {
													signupForm.confirmvalue.value = "0";
												}
									...
									$.ajax(
										{	// json 영역
											...
											success : function(data) {
												...
												if(data.indexOf('사용할 수 있는') != -1){
													signupForm.confirmtelvalue.value = "1";
												} else {
													signupForm.confirmtelvalue.value = "0";
												}
											},
											error : function(error) {
												// 실패
